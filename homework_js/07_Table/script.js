...
let idtHead = document.querySelector("#id");
let namestHead = document.querySelector("#names");
let emailtHead = document.querySelector("#email");
let gendertHead = document.querySelector("#gender");
